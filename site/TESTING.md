...
| Suite | Coverage |
| --- | --- |
| `tests/test_homepage_sidekicks.bash` | Homepage names Sidekick 0.8.0, Kay, Codex, Cursor, activation commands, stop commands, host verification, and release evidence. |
