...
var IDX = [
  ...
  { page:'Help Center', url:'../', anchor:'support',
    ...
    text:'Claude Code, Codex, and Cursor hosts can both activate Kay or Codex for the current session. Use /sidekick:kay-delegate for Kay mode and /sidekick:codex-delegate for Codex mode. The host plans, communicates, delegates, verifies, and owns final correctness.' },
