...
var IDX = [
  ...
  { page:'Help Center', url:'../', anchor:'support',
    ...
    text:'Claude Code and Codex can both route work to either agent: use /forge or /forge:delegate for Forge mode, and kay-delegate, sidekick:kay-delegate, or /kay:delegate for Kay mode. The legacy code alias remains compatibility-only. OpenCode Go remains Kay multi-AI compatibility.' },
  ...
  { page:'Core Concepts', url:'concepts/', anchor:'kay-delegation',
    ...
    text:"Kay is Sidekick's execution agent for the OSS Codex lineage. Activation starts with kay-delegate or sidekick:kay-delegate; active Kay mode routes work through kay exec --full-auto. Sidekick adds package wiring, a session-scoped .kay marker, .kay/conversations.idx, and progress summaries." },
  ...
  { page:'Reference', url:'reference/', anchor:'kay-commands',
    ...
    text:'kay exec --full-auto is the native runtime command used after Kay mode is active. kay login --provider minimax --with-api-key configures MiniMax credentials. Older binary names are compatibility-only.' },
