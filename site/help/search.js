...
var IDX = [
  ...
  { page:'Compatibility', url:'../COMPATIBILITY.md', anchor:'compatibility',
    ...
    text:'Compatibility matrix covering Claude Code and Codex host surfaces, Kay and Codex execution sidekicks, skill source of truth, command discoverability, and runtime identity.' },
  ...
  { page:'Help Center', url:'../', anchor:'support',
    ...
    text:'Claude Code and Codex hosts can both activate Kay or Codex for the current session. Use /sidekick:kay-delegate for Kay mode and /sidekick:codex-delegate for Codex mode. The host plans, communicates, delegates, verifies, and owns final correctness.' },

  // GETTING STARTED
  { page:'Getting Started', url:'getting-started/', anchor:'what-is-sidekick',
    title:'What is Sidekick?',
    text:'Sidekick is a Claude Code and Codex plugin that gives the active host two implementation sidekicks. Kay routes work through the Kay runtime and kay exec. Codex routes work through the local OpenAI Codex CLI and codex exec.' },
  ...
  { page:'Getting Started', url:'getting-started/', anchor:'codex-path',
    ...
    text:'Start Codex mode with /sidekick:codex-delegate, then describe the implementation task. The host delegates through codex exec with gpt-5.4-mini, xhigh reasoning, workspace-write sandboxing, and no approval prompts.' },
  { page:'Getting Started', url:'getting-started/', anchor:'kay-path',
    title:'Your first Kay task',
    text:'Start Kay mode through /sidekick:kay-delegate, /sidekick:kay-delegate xiaomi, or /sidekick:kay-delegate ocg. Active Kay mode creates the session marker, writes active-sidekick=kay, and routes child execution through kay exec.' },
  ...
  { page:'Core Concepts', url:'concepts/', anchor:'delegation',
    ...
    text:'When /sidekick:codex-delegate is active, implementation tasks route to the local OpenAI Codex CLI until /sidekick:codex-stop removes the current-session marker. The host remains accountable for planning and verification.' },
  { page:'Core Concepts', url:'concepts/', anchor:'kay-delegation',
    title:'Kay delegation model',
    text:'Kay is the Kay/OpenCode Go execution sidekick. Activation starts with /sidekick:kay-delegate; active Kay mode routes work through kay exec and records .kay/conversations.idx lookup metadata.' },
  ...
  { page:'Delegation Workflow', url:'workflows/', anchor:'activation',
    ...
    text:'Run /sidekick:codex-delegate to activate Codex sidekick mode. The host verifies the real Codex CLI, clears any Kay marker, writes active-sidekick=codex, and routes implementation work through codex exec.' },
  { page:'Delegation Workflow', url:'workflows/', anchor:'kay-workflow',
    title:'Kay workflow - verify, execute, review',
    text:'Run /sidekick:kay-delegate, /sidekick:kay-delegate xiaomi, or /sidekick:kay-delegate ocg. The host verifies Kay readiness, writes active-sidekick=kay, delegates through kay exec, and reviews Kay progress summaries.' },
  ...
  { page:'Reference', url:'reference/', anchor:'codex-commands',
    ...
    text:'/sidekick:kay-delegate activates Kay mode. /sidekick:kay-stop deactivates Kay mode. /sidekick:codex-delegate activates Codex mode. /sidekick:codex-stop deactivates Codex mode. Kay selectors include xiaomi and ocg.' },
  ...
  { page:'Troubleshooting', url:'troubleshooting/', anchor:'provider-config',
    ...
    text:'For Kay, choose /sidekick:kay-delegate xiaomi, /sidekick:kay-delegate ocg, or SIDEKICK_KAY_PROVIDER. For Codex, Sidekick intentionally pins gpt-5.4-mini with extra-high reasoning.' },
  ...
  { page:'Troubleshooting', url:'troubleshooting/', anchor:'recovery',
    ...
    text:'If the wrong sidekick appears active, stop the current sidekick with /sidekick:kay-stop or /sidekick:codex-stop, then activate the desired one with /sidekick:kay-delegate or /sidekick:codex-delegate.' },
