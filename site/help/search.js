...
var IDX = [
  ...
  { page:'Troubleshooting', url:'troubleshooting/', anchor:'kay-runtime',
    ...
    text:"If kay exec is unavailable, check kay --version and kay exec --help. Reinstall Sidekick or the Kay runtime if the primary binary is unavailable. If the MiniMax-backed trivial-work route is missing credentials, run kay login --provider minimax --with-api-key." },
