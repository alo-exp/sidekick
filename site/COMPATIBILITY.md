...
| Provider precedence | Host asks for the backend path the user wants | MiniMax Coding for Forge; OpenCode Go provider routing for Kay delegation | Provider choice is runtime-owned and should stay explicit. |
