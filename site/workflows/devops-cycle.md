...
**What to expect:** Structured items appended to `site/tech-debt.md` with severity,
effort, and phase introduced. Format: `| Item | Severity | Effort | Phase introduced |`.

**If it fails:** Create `site/tech-debt.md` if it does not exist, then re-run.
...
- `site/Master-PRD.md` (or `site/Infra-PRD.md` for pure infra projects)
- `site/ARCHITECTURE.md`
- `site/TESTING.md`
- `site/Runbooks.md` (DevOps-specific: one section per phase/component)
- `site/CICD.md`
