...
**Scope:** skills/forge/SKILL.md, install.sh, site/help/**/*.html, site/help/search.js
...
## Area 3: site/help/**/*.html and search.js
...
| site/help/**/*.html + search.js | PASS | 0 | 0 | 0 | 0 |
...
**Scope:** `hooks/codex-delegation-enforcer.sh`, `hooks/codex-progress-surface.sh`, `hooks/scrub-legacy-user-hooks.py`, `install.sh`, `skills/codex-stop/SKILL.md`, `sidekicks/registry.json`, `site/help/**/*.html`, `site/internal/pre-release-quality-gate.md`
...
|----|----------|---------|---------|----------|
| BC-1 | BLOCKER | `hooks/lib/enforcer-utils.sh`, `hooks/forge-delegation-enforcer.sh` | The `site/` and `.planning/` allowlist was lexical only. | CLOSED: allowed paths are canonicalized against the project root before pass-through. |
...
| The `forge -p` pipeline-tail path allowed `| tee <path>` without applying the site/.planning project allowlists to the destination. | HIGH | Current rewrite validation only preserves `tee` tails whose file arguments resolve inside `.planning/` or `site/`; unsafe tails are denied. | CLOSED |
