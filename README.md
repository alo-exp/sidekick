...
|------|--------|:---:|---------|
| **Strict unit + integration** | `tests/run_unit.bash` | ✅ | 31 non-live suites — hook classifiers, generated host skill surfaces, idx audit, plugin integrity, docs contract, homepage/help-site navigation, social preview, post-release cleanup, clean reinstall bootstrap, runner contract, marketplace release-gate regressions, and Forge/Kay coverage gaps. It removes transient root artifacts immediately before the repository layout guard. |
