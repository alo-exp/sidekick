...
| Commands | `commands/forge-stop.md`, `commands/forge-history.md`, `commands/codex-stop.md`, `commands/codex-history.md` | Canonical activation/deactivation and history workflow docs. Claude exposes them as commands; Codex exposes the Code workflows again as skill bridges under `skills/codex-stop/SKILL.md` and `skills/codex-history/SKILL.md` because its manifest does not load custom command entries. |
