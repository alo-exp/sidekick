...
| Commands | `commands/forge-stop.md`, `commands/forge-history.md`, `commands/codex-stop.md`, `commands/codex-history.md` | Canonical activation/deactivation and history workflow docs. Claude and Codex both expose them as commands; Codex materializes them as skills through the importer path, and the `skills/<name>/SKILL.md` bridges keep the source tree and picker surface aligned. |
