...
var IDX = [
  ...
  { page:'Getting Started', url:'getting-started/', anchor:'prerequisites',
    ...
    text:'Required: Claude Code or Codex host, provider key for MiniMax or Forge provider config, Node.js 18 or later for Claude Code. Sidekick auto-installs missing Forge and Kay assets on SessionStart.' },
