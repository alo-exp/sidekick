...
var IDX = [
  ...
  { page:'Core Concepts', url:'concepts/', anchor:'skill-injection',
    ...
    text:'Four bootstrap skills for injection plus code-change task mapping: testing-strategy for tests TDD, code-change for implementation edits, code-review for quality refactoring, security for auth validation credentials, quality-gates for multi-phase delivery. Injection budget max 2 skills unless multi-domain task.' },
