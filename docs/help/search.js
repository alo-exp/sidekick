...
var IDX = [
  ...
  { page:'Help Center', url:'../', anchor:'support',
    title:'Sidekick supports Claude and Codex',
    text:'Claude users delegate to Forge. Codex users delegate to Kay. Forge and Kay both support MiniMax.io, and Kay also supports OpenCode Go.' },

  // ── GETTING STARTED ───────────────────────────────────────────
  { page:'Getting Started', url:'getting-started/', anchor:'what-is-sidekick',
    title:'What is Sidekick?',
    text:'Sidekick is a Claude Code and Codex plugin that gives the active host a team of specialized AI coding agents. Forge is the Claude sidekick, and Kay is the Codex sidekick. Claude or Codex delegates entire coding tasks to the active sidekick via structured prompts.' },
  { page:'Getting Started', url:'getting-started/', anchor:'prerequisites',
    title:'Prerequisites — Claude Code, OpenRouter API key',
    text:'Required: Claude Code npm install -g anthropic claude-code. OpenRouter API key from openrouter.ai for Forge access. Node.js 18 or later. No separate Forge install needed — Sidekick auto-installs and configures ForgeCode. Codex users follow the Codex help surfaces for Kay.' },
  ...
  { page:'Getting Started', url:'getting-started/', anchor:'health-check',
    ...
    text:'Run /forge to activate and run health check. On first activation checks ~/forge/.credentials.json for API key and ~/forge/.forge.toml for provider config. Health check verifies Forge binary found, provider configured, credentials present, config valid, bootstrap skills loaded. Kay users use the Codex-side health path with MiniMax.io and OpenCode Go support.' },
