...
var IDX = [
  ...
  { page:'Help Center', url:'../', anchor:'support',
    ...
    text:'Claude Code and Codex can both route work to either agent: use /forge for Forge mode or Kay through code exec, with codex and coder compatibility aliases. OpenCode Go remains Kay multi-AI compatibility.' },
  ...
  { page:'Getting Started', url:'getting-started/', anchor:'health-check',
    ...
    text:'Run /forge to activate and run the current-session readiness check. It verifies the forge binary, forge info provider output, ~/forge/.credentials.json credential array, and ~/forge/.forge.toml provider_id/model_id. Kay users verify code --version, code exec --help, and MiniMax login.' },
  ...
  { page:'Core Concepts', url:'concepts/', anchor:'kay-delegation',
    ...
    text:'Kay is the Sidekick identity for the Every Code runtime. Primary path is code exec --full-auto with codex and coder fallbacks. Sidekick adds package wiring, a session-scoped .kay marker, .kay/conversations.idx, and progress summaries.' },
  ...
  { page:'Reference', url:'reference/', anchor:'forge-commands',
    ...
    text:'/forge activates Forge delegation mode for the current session and arms hooks after health check. /forge-stop removes the Forge marker. kay-delegate or sidekick:kay-delegate uses the Kay workflow for code codex coder runtime tasks. /kay-stop removes the Kay marker.' },
  ...
  { page:'Getting Started', url:'getting-started/', anchor:'prerequisites',
    ...
    text:'MiniMax Coding is a direct Forge provider path. Get an API key at platform.minimaxi.com. The host writes ~/forge/.credentials.json with id minimax and ~/forge/.forge.toml with provider_id minimax and model_id MiniMax-M2.7 during setup.' },
  ...
  { page:'Troubleshooting', url:'troubleshooting/', anchor:'kay-runtime',
    ...
    text:'If code exec is unavailable, check code --version, codex --version, coder --version and matching exec --help output. Reinstall Sidekick or the Kay runtime if no alias is available. If MiniMax login is missing, run code login --provider minimax --with-api-key.' },
