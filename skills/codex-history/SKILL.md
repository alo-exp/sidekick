---
name: codex-history
description: Canonical Codex history workflow. Use /codex-history or the command wrapper to list recent Codex delegation sessions and prune stale rows.
---

# Codex History Workflow
