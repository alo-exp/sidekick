---
name: forge-history
description: Canonical Forge history workflow. Use /forge-history or the command wrapper to list recent Forge tasks and prune stale rows.
---

# Forge History Workflow
