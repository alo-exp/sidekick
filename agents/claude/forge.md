...
Use the canonical fallback ladder from `forge/SKILL.md` in this generated claude skill root (`agents/claude/forge/SKILL.md` in the repository): Level 1 Guide,
...
project, and session-log tiers described by `forge/SKILL.md` in this generated claude skill root (`agents/claude/forge/SKILL.md` in the repository). Never copy
