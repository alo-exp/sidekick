...
expect_contains "tests/run_in_kay.bash" "KAY_LIVE_MODEL_PROVIDER" "Kay test wrapper exports live provider override to nested tests"
expect_contains "tests/run_in_kay.bash" "KAY_LIVE_MODEL" "Kay test wrapper exports live model override to nested tests"
...
expect_contains "tests/run_in_kay.bash" "produced no matching live-pyramid candidates" "Kay wrapper fails canonical release runs without any matching candidate"
expect_contains "tests/run_in_kay.bash" "promoting the newest entry" "Kay wrapper promotes the newest matching candidate when duplicates appear"
...
expect_contains "tests/run_live_codex_plugin_read.bash" "SIDEKICK_HOST_HOME" "Codex probe defaults tool repo from host home under Kay wrapper"
expect_contains "tests/run_live_codex_marketplace_install.bash" "SIDEKICK_HOST_HOME" "marketplace install defaults tool repo from host home under Kay wrapper"
...
expect_contains "tests/run_live_codex_marketplace_install.bash" "KAY_LIVE_MODEL_PROVIDER" "marketplace install respects the wrapper model-provider override"
