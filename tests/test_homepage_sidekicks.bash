...
expect_contains "docs/index.html" "Get MiniMax.io API Access" "homepage first setup step is current API access"
expect_contains "docs/index.html" "OpenCode Go stays in Kay's compatibility path" "homepage keeps OpenCode Go out of the user setup step"
expect_not_contains "docs/index.html" "OpenCode Go:</span> <span class=\"cmd\">API access</span>" "homepage does not present OpenCode Go as a separate setup action"
...
expect_contains "docs/index.html" "Forge:</span> <span class=\"cmd\">/forge</span>" "homepage shows Forge session activation"
expect_not_contains "docs/index.html" "/forge implement X" "homepage does not treat /forge as a task command"
expect_contains "docs/index.html" "Kay:</span> <span class=\"cmd\">kay-delegate -&gt; code exec --full-auto" "homepage shows Kay delegate workflow"
