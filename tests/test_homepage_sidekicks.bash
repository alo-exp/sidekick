...
expect_not_contains "docs/index.html" "section-label\">Installation" "homepage removes the dedicated installation section label"
expect_not_contains "docs/index.html" "Install Once, Delegate Per Session" "homepage removes sync-every-session install framing"
