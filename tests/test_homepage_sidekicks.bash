...
expect_contains "docs/index.html" "kay exec --full-auto" "homepage documents Kay primary exec path"
...
expect_contains "docs/index.html" "https://platform.minimax.io/subscribe/token-plan" "homepage includes current MiniMax token-plan URL"
expect_contains "docs/index.html" "https://opencode.ai/docs/go/" "homepage includes OpenCode Go docs URL"
...
expect_contains "docs/index.html" "Kay:</span> <span class=\"cmd\">kay exec --full-auto" "homepage shows Kay binary delegation"
