...
KAY_LIVE_MODEL_PROVIDER_Q="$(quote_value "${KAY_LIVE_MODEL_PROVIDER}")"
KAY_LIVE_MODEL_Q="$(quote_value "${KAY_LIVE_MODEL}")"
cat >"${SCRIPT_FILE}" <<EOF
#!/usr/bin/env bash
...
export SIDEKICK_HOST_HOME=${HOST_HOME_Q}
export KAY_LIVE_MODEL_PROVIDER=${KAY_LIVE_MODEL_PROVIDER_Q}
export KAY_LIVE_MODEL=${KAY_LIVE_MODEL_Q}
